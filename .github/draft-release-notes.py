...
because they are specific to this repository and should be reviewed here.
...
def build_prompts(args: argparse.Namespace) -> tuple[str, str]:
    ...
    The system prompt is this repository's prompt file with the release
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        help="This repository's half of the prompt.",
    )
    parser.add_argument(
        '--changelog',
        required=True,
