...
rejecting a mismatch with an :class:`~ops.testing.errors.IsolationError`
...
class IsolatedContext:
    ...
    Invariant:
        ...
        process's; there is no cross-version negotiation. A mismatch raises
        :class:`IsolationError`, naming both versions.
