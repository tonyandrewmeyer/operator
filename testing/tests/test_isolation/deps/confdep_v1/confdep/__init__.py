...
VERSION = '1.0'  # ruff: ignore[non-empty-init-module]
LEGACY_NAME = 'alpha-only-name'  # ruff: ignore[non-empty-init-module]


def compute() -> int:  # ruff: ignore[non-empty-init-module]
    return 1
