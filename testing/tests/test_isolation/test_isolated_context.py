...
from scenario._isolation import _IsolatedEnv, _read_charm_metadata
...
def test_read_charm_metadata_reads_metadata_yaml():
...
def test_nonexistent_metadata_raises_runtime_error(tmp_path: pathlib.Path):
